...
from ...models.paginated_member_address_list import PaginatedMemberAddressList
...
) -> PaginatedMemberAddressList | None:
    if response.status_code == 200:
        response_200 = PaginatedMemberAddressList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PaginatedMemberAddressList]:
    return Response(
