...
T = TypeVar("T", bound="PaginatedMemberJobList")


@_attrs_define
class PaginatedMemberJobList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[MemberJob]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = MemberJob.from_dict(results_item_data)
        ...
        paginated_member_job_list.additional_properties = d
        return paginated_member_job_list
