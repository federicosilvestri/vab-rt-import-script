...
T = TypeVar("T", bound="PaginatedSubscriptionList")
...
class PaginatedSubscriptionList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Subscription.from_dict(results_item_data)
        ...
        paginated_subscription_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_subscription_list.additional_properties = d
        return paginated_subscription_list
