...
T = TypeVar("T", bound="PaginatedCAPList")


@_attrs_define
class PaginatedCAPList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = CAP.from_dict(results_item_data)
        ...
        paginated_cap_list.additional_properties = d
        return paginated_cap_list
