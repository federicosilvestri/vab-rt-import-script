...
T = TypeVar("T", bound="PatchedMemberAddress")


@_attrs_define
class PatchedMemberAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_member_address.additional_properties = d
        return patched_member_address
