...
if TYPE_CHECKING:
    from ..models.regione import Regione


T = TypeVar("T", bound="PaginatedRegioneList")


@_attrs_define
class PaginatedRegioneList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[Regione]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Regione.from_dict(results_item_data)
        ...
        paginated_regione_list.additional_properties = d
        return paginated_regione_list
