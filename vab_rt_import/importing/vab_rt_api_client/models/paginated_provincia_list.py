...
T = TypeVar("T", bound="PaginatedProvinciaList")


@_attrs_define
class PaginatedProvinciaList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[Provincia]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Provincia.from_dict(results_item_data)
        ...
        paginated_provincia_list.additional_properties = d
        return paginated_provincia_list
