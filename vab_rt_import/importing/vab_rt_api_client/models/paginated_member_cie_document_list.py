...
T = TypeVar("T", bound="PaginatedMemberCIEDocumentList")


@_attrs_define
class PaginatedMemberCIEDocumentList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[MemberCIEDocument]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = MemberCIEDocument.from_dict(results_item_data)
        ...
        paginated_member_cie_document_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_member_cie_document_list.additional_properties = d
        return paginated_member_cie_document_list
