...
from ...models.patched_member_education import PatchedMemberEducation
...
def _get_kwargs(
    ...
    id: int,
    *,
    body: PatchedMemberEducation | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/members/member/{member_pk}/education/{id}/".format(
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> MemberEducation | None:
    if response.status_code == 200:
        response_200 = MemberEducation.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Retrieve, update, or delete a single education record for a member.

    Args:
        member_pk (int):
        id (int):
        body (PatchedMemberEducation | Unset): Serializer for MemberEducation.
