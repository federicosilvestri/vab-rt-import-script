...
T = TypeVar("T", bound="PatchedCompany")


@_attrs_define
class PatchedCompany:
    """Serializer for Company (employer).
    ...
    (Italian fields vs foreign_address).
        ...
        Attributes:
            id (int | Unset):
            name (str | Unset): Nome dell'azienda, ragione sociale
            vat (str | Unset): Partita IVA completa
            pec (str | Unset): Indica un riferimento email per l'azienda
            mail (str | Unset): Indica la PEC dell'azienda
            phone_number (str | Unset): Indica un recapito telefono
            country (BirthCountryEnum | Unset): * `AF` - Afghanistan
                ...
                * `ZM` - Zambia
                * `ZW` - Zimbabwe
            foreign_address (str | Unset): Indirizzo sede legale estero, da compilare solo in cui         la nazione non sia
                italiana.
            region (int | None | Unset): Regione dove risiede la sede legale
            province (int | None | Unset): Provincia dove risiede la sede legale
            comune (int | None | Unset): Comune dove risiede la sede legale
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_company.additional_properties = d
