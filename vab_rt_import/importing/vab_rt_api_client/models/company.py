...
class Company:
    ...
    (Italian fields vs foreign_address).
        ...
        Attributes:
            id (int):
            name (str): Nome dell'azienda, ragione sociale
            vat (str): Partita IVA completa
            pec (str): Indica un riferimento email per l'azienda
            phone_number (str): Indica un recapito telefono
