...
T = TypeVar("T", bound="PaginatedMemberPhoneList")


@_attrs_define
class PaginatedMemberPhoneList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[MemberPhone]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = MemberPhone.from_dict(results_item_data)
        ...
        paginated_member_phone_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_member_phone_list.additional_properties = d
        return paginated_member_phone_list
