...
from ...models.patched_member_cie_document import PatchedMemberCIEDocument
...
def _get_kwargs(
    ...
    id: int,
    *,
    body: PatchedMemberCIEDocument | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        member_pk (int):
        id (int):
        body (PatchedMemberCIEDocument | Unset): Serializer for MemberCIEDocument (Carta di
