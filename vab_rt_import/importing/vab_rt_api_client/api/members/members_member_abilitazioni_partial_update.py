...
from ...models.patched_member_abilitazione import PatchedMemberAbilitazione
...
def _get_kwargs(
    ...
    id: int,
    *,
    body: PatchedMemberAbilitazione | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        member_pk (int):
        id (int):
        body (PatchedMemberAbilitazione | Unset): Serializer for MemberAbilitazione (assignment of
            an Abilitazione to a Member).
