...
T = TypeVar("T", bound="PaginatedComuneList")


@_attrs_define
class PaginatedComuneList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Comune.from_dict(results_item_data)
        ...
        paginated_comune_list.additional_properties = d
        return paginated_comune_list
