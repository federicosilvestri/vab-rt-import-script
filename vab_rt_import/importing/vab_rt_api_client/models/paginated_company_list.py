...
T = TypeVar("T", bound="PaginatedCompanyList")
...
class PaginatedCompanyList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Company.from_dict(results_item_data)
        ...
        paginated_company_list.additional_properties = d
        return paginated_company_list
