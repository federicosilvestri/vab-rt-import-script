...
T = TypeVar("T", bound="PaginatedAbilitazioneList")


@_attrs_define
class PaginatedAbilitazioneList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[Abilitazione]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Abilitazione.from_dict(results_item_data)
        ...
        paginated_abilitazione_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_abilitazione_list.additional_properties = d
        return paginated_abilitazione_list
