...
T = TypeVar("T", bound="PaginatedQualificaList")


@_attrs_define
class PaginatedQualificaList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[Qualifica]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Qualifica.from_dict(results_item_data)
        ...
        paginated_qualifica_list.additional_properties = d
        return paginated_qualifica_list
