...
from ...models.paginated_member_education_list import PaginatedMemberEducationList
...
) -> PaginatedMemberEducationList | None:
    if response.status_code == 200:
        response_200 = PaginatedMemberEducationList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PaginatedMemberEducationList]:
    return Response(
