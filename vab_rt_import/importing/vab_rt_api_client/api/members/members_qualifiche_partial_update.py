...
from ...models.patched_qualifica import PatchedQualifica
...
def _get_kwargs(
    id: int,
    *,
    body: PatchedQualifica | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedQualifica | Unset): Read-only lookup serializer for Qualifica.
