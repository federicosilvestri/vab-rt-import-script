...
from ...models.paginated_member_driver_license_document_list import PaginatedMemberDriverLicenseDocumentList
...
) -> PaginatedMemberDriverLicenseDocumentList | None:
    if response.status_code == 200:
        response_200 = PaginatedMemberDriverLicenseDocumentList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PaginatedMemberDriverLicenseDocumentList]:
    return Response(
