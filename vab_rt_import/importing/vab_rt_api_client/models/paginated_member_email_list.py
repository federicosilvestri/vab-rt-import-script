...
T = TypeVar("T", bound="PaginatedMemberEmailList")


@_attrs_define
class PaginatedMemberEmailList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[MemberEmail]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = MemberEmail.from_dict(results_item_data)
        ...
        paginated_member_email_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_member_email_list.additional_properties = d
        return paginated_member_email_list
