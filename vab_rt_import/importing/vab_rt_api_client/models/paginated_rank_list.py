...
T = TypeVar("T", bound="PaginatedRankList")


@_attrs_define
class PaginatedRankList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Rank.from_dict(results_item_data)
        ...
        paginated_rank_list.additional_properties = d
        return paginated_rank_list
