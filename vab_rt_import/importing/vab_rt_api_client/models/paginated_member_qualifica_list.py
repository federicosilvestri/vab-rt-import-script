...
T = TypeVar("T", bound="PaginatedMemberQualificaList")


@_attrs_define
class PaginatedMemberQualificaList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[MemberQualifica]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = MemberQualifica.from_dict(results_item_data)
        ...
        paginated_member_qualifica_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_member_qualifica_list.additional_properties = d
        return paginated_member_qualifica_list
