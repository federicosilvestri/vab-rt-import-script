...
T = TypeVar("T", bound="PaginatedMemberDriverLicenseCategoryList")


@_attrs_define
class PaginatedMemberDriverLicenseCategoryList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[MemberDriverLicenseCategory]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = MemberDriverLicenseCategory.from_dict(results_item_data)
        ...
        paginated_member_driver_license_category_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_member_driver_license_category_list.additional_properties = d
        return paginated_member_driver_license_category_list
