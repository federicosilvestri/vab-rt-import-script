...
from ...models.paginated_member_list_list import PaginatedMemberListList
...
) -> PaginatedMemberListList | None:
    if response.status_code == 200:
        response_200 = PaginatedMemberListList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PaginatedMemberListList]:
    return Response(
