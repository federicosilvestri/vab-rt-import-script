...
T = TypeVar("T", bound="MemberEducation")
...
class MemberEducation:
    ...
    The model's clean() validates this constraint.
        ...
        Attributes:
            id (int):
            member (int):
            education_type (EducationTypeEnum): * `TERZA_MEDIA` - Diploma Terza Media
            ...
            name (str): Nome della scuola/istituto/università
            program_name (str): Programma della scuola/istituto o nome della facoltà
            end_date (datetime.date): Indicare la data di conseguimento del titolo.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        education_type = EducationTypeEnum(d.pop("education_type"))
        ...
        member_education.additional_properties = d
