...
T = TypeVar("T", bound="PaginatedMemberDriverLicenseDocumentList")


@_attrs_define
class PaginatedMemberDriverLicenseDocumentList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[MemberDriverLicenseDocument]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = MemberDriverLicenseDocument.from_dict(results_item_data)
        ...
        paginated_member_driver_license_document_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_member_driver_license_document_list.additional_properties = d
        return paginated_member_driver_license_document_list
